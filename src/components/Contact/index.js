    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>
          Estoy muy interesado en cualquier oportunidad laboral que requiera talento
           y mucha dedicación, no dudes en escribirme,
           de donde vengo nos encanta resolver problemas y dar solución a todo sin importar lo difícil que sea la situación
          </p>
        ...
        <div className="info-map">
          ...
          <br/>
          <span>numero de telefono: 58-4246250714</span>
        </div>
        <div className="map-wrap">
        <MapContainer center={[10.671288, -71.674868]} zoom={13}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[10.671288, -71.674868]}>
              <Popup>Wilmer vive aqui, pasate por una taza de cafe :)</Popup>
            </Marker>
          </MapContainer>
        </div>
      </div>
